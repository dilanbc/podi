...
String url = "http://powerpanel123.000webhostapp.com/write.php";  //URL for HTTP-POST-REQUEST
...
void loop() { // run over and over
    ...
    data="?up=L"+data+"V"+String(vol)+"A"+String(amp)+"E";
    Serial.println(data);
...
void gsm_sendhttp() {
  ...
  runsl();
  delay(100);
  mySerial.println("AT+HTTPPARA=URL," + url+data);
  runsl();
  delay(100);   
