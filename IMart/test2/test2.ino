...
void readdata(){
 ...
 double r4=EEPROM.read(4);
 r4=r4*16777216;
 r4=r4/10000000;
 R=r4;
 Serial.println(r4,8);
 
 double r3=EEPROM.read(3);
 r3=r3*65536;
 r3=r3/10000000;
 R=R+r3;
 Serial.println(r3,7);
 
 double r2=EEPROM.read(2);
 r2=r2*256;
 r2=r2/10000000;
 R=R+r2;
 Serial.println(r2,7);

 float r1=EEPROM.read(1);
 r1=r1/10000000;
 Serial.println(r1,7);
 ...
 readvalue2=readvalue+R;
 Serial.print("read value - ");

 Serial.println(readvalue2,7);
}
