...
void setTime(uint8_t hSet,uint8_t mSet,uint8_t sSet ,uint8_t dateSet,uint8_t monthSet, uint8_t yearSet);
void Readtime();
...
{	
	...
	//setTime(22,9,36,23,12,21); //hour , minute, second, date, month, year
