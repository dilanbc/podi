...
void loop()
{
  ...
  if(j==0){
    ...
    Serial.printf("Set state... %s\n", Firebase.RTDB.setInt(&fbdo, "/Users/7kotKgbzyPUOEnD4fc10chT4kH72/state", false) ? "ok" : fbdo.errorReason().c_str());

   //Serial.printf("Get credit... %s\n", Firebase.RTDB.getInt(&fbdo, "/A/credit") ? String(fbdo.intData()).c_str() : fbdo.errorReason().c_str());
  if(Firebase.RTDB.getInt(&fbdo, "/Users/7kotKgbzyPUOEnD4fc10chT4kH72/credit")){
    ...
    if(creditb<chargeV){
     ...
     tone(buzzer,2000,100);
      ...
      lcd.clear();
        ...
        delay(1);
      Serial.printf("Set credit... %s\n", Firebase.RTDB.setInt(&fbdo, "/Users/7kotKgbzyPUOEnD4fc10chT4kH72/credit", creditb-chargeV) ? "ok" : fbdo.errorReason().c_str());
    }
...
if(j==1){
    Serial.printf("Set state... %s\n", Firebase.RTDB.setInt(&fbdo, "/Users/8oolWAVtv1f0EHLm54Ox84ZAAvB2/state", false) ? "ok" : fbdo.errorReason().c_str());

  
    if(Firebase.RTDB.getInt(&fbdo, "/Users/8oolWAVtv1f0EHLm54Ox84ZAAvB2/credit")){
    int creditb= fbdo.intData();
  if(creditb<chargeV){
     lcd.clear();
     lcd.setCursor(0,0);
     ...
     tone(buzzer,2000,100);
      ...
      lcd.clear();
        ...
        tone(buzzer, 4000,100);
        delay(1);
       Serial.printf("Set credit... %s\n", Firebase.RTDB.setInt(&fbdo, "/Users/8oolWAVtv1f0EHLm54Ox84ZAAvB2/credit", creditb-chargeV) ? "ok" : fbdo.errorReason().c_str());
    }
...
if(j==2){
    Serial.printf("Set state... %s\n", Firebase.RTDB.setInt(&fbdo, "/Users/jAPOuZ1jq2eKkyJmK6g51UsPoMB2/state", false) ? "ok" : fbdo.errorReason().c_str());

  
    if(Firebase.RTDB.getInt(&fbdo, "/Users/jAPOuZ1jq2eKkyJmK6g51UsPoMB2/credit")){
    int creditb= fbdo.intData();
    if(creditb<chargeV){
     lcd.clear();
     lcd.setCursor(0,0);
     ...
     tone(buzzer,2000,100);
      ...
      lcd.clear();
        ...
        tone(buzzer, 4000,100);
        delay(1);
      Serial.printf("Set credit... %s\n", Firebase.RTDB.setInt(&fbdo, "/Users/jAPOuZ1jq2eKkyJmK6g51UsPoMB2/credit", creditb-chargeV) ? "ok" : fbdo.errorReason().c_str()); 
    }
