...
bool sms_patentfall=0;
bool sms_location=0;
bool sms_batterylow=0;
bool sms_emergency=0;
...
void sendSMS(char*msg){
	...
	_delay_ms(500);
	sprintf(lengthcal,"AT+CMGS=\"+94%s\"","713673133");
